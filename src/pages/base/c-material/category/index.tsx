...
const CMaterialCategory: React.FC = () => {
    ...
    <PageContainer>
      <ProTable<CategoryItem>
        ...
        request={async (params) => {
          ...
          const res = await fetch(`/api/base/c-material/category?${qs}`).then(
            (r) => r.json(),
          );
        ...
        toolBarRender={() => [
          <DrawerForm
            ...
            onFinish={async (values) => {
              await fetch('/api/base/c-material/category', {
                method: 'POST',
...
export default CMaterialCategory;
