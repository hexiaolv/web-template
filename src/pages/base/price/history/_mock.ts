...
export default defineMock({
  'GET /api/base/price/history': (req: any, res: any) => {
    const { keyword, changeType, current = 1, pageSize = 10 } = req.query;
    ...
    if (changeType)
      filtered = filtered.filter((i) => i.changeType === changeType);
    if (keyword) {
