        ...
        routes: [
          {
            ...
            component: './base/c-material/items',
          },
          {
            name: 'udi',
            path: '/base/c-material/udi',
            icon: 'ScanOutlined',
            component: './base/c-material/udi',
          },
          {
            name: 'category',
            path: '/base/c-material/category',
            icon: 'TagOutlined',
            component: './base/c-material/category',
          },
          {
            name: 'unit',
            path: '/base/c-material/unit',
            icon: 'CalculatorOutlined',
            component: './base/c-material/unit',
          },
        ],
      },
        ...
        routes: [
          {
            ...
            icon: 'FileTextOutlined',
            component: './base/m-material/items',
          },
          {
            name: 'code',
            path: '/base/m-material/code',
            icon: 'ScanOutlined',
            component: './base/m-material/code',
          },
          {
            name: 'category',
            path: '/base/m-material/category',
            icon: 'TagOutlined',
            component: './base/m-material/category',
          },
          {
            name: 'unit',
            path: '/base/m-material/unit',
            icon: 'CalculatorOutlined',
            component: './base/m-material/unit',
          },
        ],
      },
      // 通用数据分组
        ...
        routes: [
          {
            ...
            icon: 'IdcardOutlined',
            component: './base/supplier/profile',
          },
          {
            name: 'certs',
            path: '/base/supplier/certs',
            icon: 'SafetyCertificateOutlined',
            component: './base/supplier/certs',
          },
          {
            name: 'kpi',
            path: '/base/supplier/kpi',
            icon: 'StarOutlined',
            component: './base/supplier/kpi',
          },
        ],
      },
      {
        ...
        routes: [
          {
            ...
            icon: 'DollarOutlined',
            component: './base/price/list',
          },
          {
            name: 'apply',
            path: '/base/price/apply',
            icon: 'SwapOutlined',
            component: './base/price/apply',
          },
          {
            name: 'history',
            path: '/base/price/history',
            icon: 'LineChartOutlined',
            component: './base/price/history',
          },
        ],
      },
    ],
